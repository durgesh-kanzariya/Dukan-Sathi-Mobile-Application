...
class _ChangePasswordAdminState extends State<ChangePasswordAdmin> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // The bottom navigation bar has been removed as requested.
    );
  }
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(12),
          borderSide: const BorderSide(color: Color(0xFF5A7D60), width: 2.0),
        ),
        prefixIcon: const Icon(Icons.lock_outline, color: Color(0xFF5A7D60)),
